...
export default function EventDetailError({ error, reset }: ErrorProps) {
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white p-6 md:p-8 font-sans flex flex-col items-center justify-center gap-6">
      <h1 className="text-2xl font-bold text-zinc-400">Error al cargar el recital</h1>
      ...
      <div className="flex gap-3">
        ...
        <Link href={routes.home}><Button type="button" variant="secondary">Volver al listado</Button></Link>
      </div>
    </main>
  )
}
